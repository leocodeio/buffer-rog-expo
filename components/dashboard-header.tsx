    ...
    >
      <View className="flex flex-col gap-3">
        ...
        <View className="flex-row justify-between items-center">
          <View>
            <Text className="font-bold text-xs">Blinkit in</Text>
            <Text className="font-bold text-xl leading-tight">16 minutes</Text>
          </View>
        ...
        <View className="flex-row items-center gap-1">
          <Text className="text-[10px] font-bold">HOME -</Text>
